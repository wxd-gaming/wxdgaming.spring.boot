...
@Getter
@Component
public class SkillHealHpEffectExecutor extends AbstractSkillEffectExecutor {


    @Override public SkillEffectType skillEffectType() {
        return SkillEffectType.HealHp;
    }
    ...
    @Override protected void onExecute(MapObject self, Skill skill, SkillEffect skillEffect, MapObject target) {
        ...
        log.debug(
                ...
                self.getName(), skill.getSkillCfg(), skillEffect.getName(), target.getName(), random, target.getHp()
        );
    }
