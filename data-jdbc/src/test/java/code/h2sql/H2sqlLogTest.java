...
public class H2sqlLogTest extends EntityBase<Long> {
    ...
    @Override public H2sqlLogTest setCreatedTime(Long createdTime) {
        super.setCreatedTime(createdTime);
        return this;
    }

    @Override public H2sqlLogTest setUid(Long uid) {
        super.setUid(uid);
        return this;
    }
