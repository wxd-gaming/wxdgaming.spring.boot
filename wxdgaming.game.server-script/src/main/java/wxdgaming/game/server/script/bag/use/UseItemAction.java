...
public abstract class UseItemAction extends HoldRunApplication implements IBagScript {
    ...
    public boolean canUse(Player player, BagChangesCourse bagChangesCourse, Item item) {
        return false;
    }

    public void doUse(Player player, BagChangesCourse bagChangesCourse, Item item) {
