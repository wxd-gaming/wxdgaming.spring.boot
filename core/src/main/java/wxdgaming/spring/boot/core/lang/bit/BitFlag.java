...
public class BitFlag implements Serializable {
    ...
    public String toString() {
        ...
        if (longs != null) {
            for (Long aLong : longs) {
                show = toBinaryString("", StringsUtil.padLeft(Long.toBinaryString(aLong), 64, '0'))
                        + (StringsUtil.emptyOrNull(show) ? "" : "_")
                        + show;
            }
        }
        return "0b" + show;
    ...
    public static String toString(short i) {
        String string = StringsUtil.padLeft(Integer.toBinaryString(i), 16, '0');
        return toBinaryString("0b", string);
    }

    public static String toString(int i) {
        String string = StringsUtil.padLeft(Integer.toBinaryString(i), 32, '0');
        return toBinaryString("0b", string);
    }

    public static String toString(long l) {
        String string = StringsUtil.padLeft(Long.toBinaryString(l), 64, '0');
        return toBinaryString("0b", string);
    }
