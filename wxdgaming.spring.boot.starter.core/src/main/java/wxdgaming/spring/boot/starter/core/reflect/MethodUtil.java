...
public class MethodUtil {
    ...
    /** 查找方法 */
    public static Method findMethod(Class<?> clazz, String prefix, Field field, int parameterCount) {
        return findMethod(clazz, field, prefix, field.getName(), parameterCount);
    }

    public static Method findMethod(Class<?> clazz, Field field, String prefix, String fieldName, int parameterCount) {
