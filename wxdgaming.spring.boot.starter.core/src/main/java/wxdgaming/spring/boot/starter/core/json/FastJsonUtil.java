...
import wxdgaming.spring.boot.starter.core.lang.bit.BitFlag;
import wxdgaming.spring.boot.starter.core.util.MergeUtil;
...
public class FastJsonUtil {
    ...
    public static <T> T parse(byte[] bytes, TypeReference<T> tTypeReference) {
        return JSON.parseObject(bytes, tTypeReference.getType(), Reader_Features);
    }
