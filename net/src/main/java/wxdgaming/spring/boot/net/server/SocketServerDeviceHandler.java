...
public class SocketServerDeviceHandler extends SocketDeviceHandler {
    ...
    @Override public void channelRegistered(ChannelHandlerContext ctx) throws Exception {
        ...
        socketSession.setMaxFrameBytes(socketService.getServerConfig().getMaxFrameBytes());
        socketSession.setMaxFrameLength(socketService.getServerConfig().getMaxFrameLength());
