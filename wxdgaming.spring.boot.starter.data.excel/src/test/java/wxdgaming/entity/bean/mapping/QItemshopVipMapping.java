...
import wxdgaming.spring.boot.starter.core.timer.CronExpress;
import wxdgaming.spring.boot.starter.data.excel.store.DataKey;
import wxdgaming.spring.boot.starter.data.excel.store.DataMapping;
...
public abstract class QItemshopVipMapping extends ObjectBase implements Serializable, DataKey {
    ...
    protected int id;
    /** 商品内容 */
    protected ConfigString shop_item;
    /** 如果数据库关联字符串超长 */
    ...
    /** cron表达式 */
    protected CronExpress show_time;
    /** 是非类型 */
